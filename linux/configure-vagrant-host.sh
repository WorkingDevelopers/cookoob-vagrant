...
PROJECT_NAME='cookoob'
declare -A VM_IPS
VM_IPS[apache2]='192.168.56.190'
VM_IPS[nginx]='192.168.56.191'
...
function setup-hosts() {
    ...
    echo "${VM_IPS[nginx]}    ${PROJECT_CODENAME}.nginx.dev www.${PROJECT_CODENAME}.nginx.dev api.${PROJECT_CODENAME}.nginx.dev" >> "$TMP"
    echo "${VM_IPS[apache2]}    ${PROJECT_CODENAME}.apache.dev www.${PROJECT_CODENAME}.apache.dev api.${PROJECT_CODENAME}.apache.dev" >> "$TMP"
